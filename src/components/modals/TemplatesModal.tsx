...
const TemplatesModalComponent: React.FC<TemplatesModalProps> = ({
  isOpen,
  onClose,
  onApplyTemplate,
}) => {
  ...
  return (
    <div className="modal-backdrop fixed inset-0 z-50 flex items-center justify-center p-4" role="presentation" onClick={onClose}>
      <div
        ref={trapRef}
...
export const TemplatesModal = React.memo(TemplatesModalComponent);
