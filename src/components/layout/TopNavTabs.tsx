...
const TopNavTabsComponent: React.FC<TopNavTabsProps> = ({ activeTab, onChangeTab }) => {
  return (
...
export const TopNavTabs = React.memo(TopNavTabsComponent);
TopNavTabs.displayName = 'TopNavTabs';
