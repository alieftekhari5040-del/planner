...
const LessonsCardComponent: React.FC<LessonsCardProps> = ({ lessons, onChange }) => {
...
export const LessonsCard = React.memo(LessonsCardComponent);
LessonsCard.displayName = 'LessonsCard';
