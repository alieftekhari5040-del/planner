...
const PrioritiesCardComponent: React.FC<PrioritiesCardProps> = ({
  priorities,
  onChange,
  onItemToggle,
}) => {
...
export const PrioritiesCard = React.memo(PrioritiesCardComponent);
PrioritiesCard.displayName = 'PrioritiesCard';
