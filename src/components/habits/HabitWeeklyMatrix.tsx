...
const HabitWeeklyMatrixComponent: React.FC<HabitWeeklyMatrixProps> = ({
  habits,
  onToggleCell,
  onAddHabit,
  onDeleteHabit,
...
export const HabitWeeklyMatrix = React.memo(HabitWeeklyMatrixComponent);
HabitWeeklyMatrix.displayName = 'HabitWeeklyMatrix';
